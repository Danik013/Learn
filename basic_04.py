...
red_monro_blend = Image.blend(red_cropped_mid, red_cropped_left, 0.5)
...
blue_monro_blend = Image.blend(blue_cropped_mid, blue_cropped_right, 0.5)

green_coord_mid = (25, 0, 671, green_monro.height)
green_cropped_mid = green_monro.crop(green_coord_mid)

new_monro = Image.merge("RGB", (red_monro_blend, green_cropped_mid, blue_monro_blend))
new_monro.save("new_monro.jpg")
avatar = Image.merge("RGB", (red_monro_blend, green_cropped_mid, blue_monro_blend))
