...
def main():
    ...
    def wait(chat_id, question):
        ...
        bot.create_countdown(pytimeparse.parse(question), notify_progress, chat_id=chat_id, message_id=message_id, question=question)
        bot.create_timer(pytimeparse.parse(question), choose, chat_id=chat_id, message_id=message_id)
